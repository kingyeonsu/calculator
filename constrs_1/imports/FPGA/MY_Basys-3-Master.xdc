...
#set_property -dict { PACKAGE_PIN T2   IOSTANDARD LVCMOS33 } [get_ports { i_select[0] }]; #IO_L1N_T0_34               ,Sch=SW10
set_property -dict { PACKAGE_PIN R3   IOSTANDARD LVCMOS33 } [get_ports { i_select[0] }]; #IO_L2P_T0_34               ,Sch=SW11
set_property -dict { PACKAGE_PIN W2   IOSTANDARD LVCMOS33 } [get_ports { i_select[1] }]; #IO_L5N_T0_34               ,Sch=SW12
...
#set_property -dict { PACKAGE_PIN W18  IOSTANDARD LVCMOS33 } [get_ports { o_c  }]; #IO_L16P_T2_CSI_B_14          ,Sch=LED4
...
#set_property -dict { PACKAGE_PIN L1   IOSTANDARD LVCMOS33 } [get_ports { o_c }]; #IO_L6N_T0_VREF_35            ,Sch=LED15
